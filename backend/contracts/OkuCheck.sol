...
contract OkuCheck{
    ...
    event OkuVerfied(address indexed person, bool indexed verfied);
    ...
    function verifyOku(uint256[8] calldata _proof,uint256[2] calldata _input) public {
       ...
       emit OkuVerfied(msg.sender,true);
    }
    ...
    function setVerficationStatus(bool _status) public{
      ...
      emit OkuVerfied(msg.sender,_status);
    }
}